<div class="fixed z-30 inset-0 overflow-y-auto" x-show="isOpenModalAddAmenitie" x-cloak>
    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">

        <div x-show="isOpenModalAddAmenitie" x-transition:enter="ease-out duration-300"
        ...
        <div x-show="isOpenModalAddAmenitie" x-transition:enter="ease-out duration-300"
            ...
            @click.away="closeModalAddAmenitie" @keydown.escape="closeModalAddAmenitie"
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        <div class="flex items-center justify-between">
                            <h3 class="text-lg leading-6 font-medium text-gray-700">Ajouter une commodité</h3>
                        </div>

                        <div class="mt-5">
                            <form action="{{ route('amenitie.store') }}" method="POST" class="w-full"
                                id="addAmenitieForm">
                                @csrf
                                <div>
    ...
    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
        <button type="submit" @click.prevent="addAmenitie" id="addAmenitieAction"
        ...
        <button type="button" @click.prevent="closeModalAddAmenitie"
