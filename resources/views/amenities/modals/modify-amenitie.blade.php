<div class="fixed z-30 inset-0 overflow-y-auto" x-show="isOpenModalModifyAmenitie"
    @edit-amenitie.window="openModalModifyAmenitie($event.detail.url, $event.detail.title, $event.detail.description)"
    x-cloak>

    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">

        <div x-show="isOpenModalModifyAmenitie" x-transition:enter="ease-out duration-300"
        ...
        <div x-show="isOpenModalModifyAmenitie" x-transition:enter="ease-out duration-300"
            ...
            @click.away="closeModalModifyAmenitie" @keydown.escape="closeModalModifyAmenitie"
                ...
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        <div class="flex items-center justify-between">
                            <h3 class="text-lg leading-6 font-medium text-gray-700">Modifier la commodité</h3>
                        </div>

                        <div class="mt-5">
                            <form action="" method="POST" class="w-full" id="modifyAmenitieForm">
                                @csrf
                                <div>
                                    <div class="rounded-md shadow-sm">
                                        <input type="text" name="title" id="" placeholder="Titre (Royal vie)"
                                ...
                                <div class="mt-3">
                                    <div class="rounded-md shadow-sm">
                                        <input type="text" name="description" id=""
                                            placeholder="Description (Repas, piscine, sport, safari)"
                                            class="appearance-none block w-full px-3 py-2 border border-gray-300 font-medium rounded-md placeholder-gray-400 focus:outline-none focus:border-blue-500 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                                    </div>
                                </div>
                                {{-- //////////////////// --}}
                                {{-- <div class="mt-3">
                                    <div class="rounded-md shadow-sm">
                                        ...
                                        <input type="date" name="date_start" id="date_start" placeholder=""
                                            class="appearance-none block w-full px-3 py-2 border border-gray-300 font-medium rounded-md placeholder-gray-400 focus:outline-none focus:border-blue-500 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                                    </div>
                                </div>
                                <div class="mt-3">
                                    <div class="rounded-md shadow-sm">
                                        ...
                                        <input type="date" name="date_end" id="date_end" placeholder=""
                                            class="appearance-none block w-full px-3 py-2 border border-gray-300 font-medium rounded-md placeholder-gray-400 focus:outline-none focus:border-blue-500 transition duration-150 ease-in-out sm:text-sm sm:leading-5">
                                    </div>
                                </div> --}}
                            </form>
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="submit" @click.prevent="modifyAmenitie" id="modifyAmenitieAction"
                ...
                <button type="button" @click.prevent="closeModalModifyAmenitie"
