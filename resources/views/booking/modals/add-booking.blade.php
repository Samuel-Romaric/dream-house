<div class="fixed z-30 inset-0 overflow-y-auto" x-show="isOpenModalAddBooking" x-cloak>

    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">

        <div x-show="isOpenModalAddBooking" x-transition:enter="ease-out duration-300"
        ...
        <div x-show="isOpenModalAddBooking" x-transition:enter="ease-out duration-300"
            ...
            @click.away="closeModalAddBooking" @keydown.escape="closeModalAddBooking"
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="submit" @click.prevent="addBooking" id="addBookingAction"
                ...
                <button type="button" @click.prevent="closeModalAddBooking"
