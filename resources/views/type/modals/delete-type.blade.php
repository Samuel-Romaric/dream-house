<div class="fixed z-30 inset-0 overflow-y-auto" x-show="isOpenModalDeleteType"
    @delete-type.window="openModalDeleteType($event.detail.url, $event.detail.title)" x-cloak>

    <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">

        <div x-show="isOpenModalDeleteType" x-transition:enter="ease-out duration-300"
        ...
        <div x-show="isOpenModalDeleteType" x-transition:enter="ease-out duration-300"
            ...
            @click.away="closeModalDeleteType" @keydown.escape="closeModalDeleteType"
            ...
            <div class="bg-white px-3 py-3">
                <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div class="mt-5">
                            <form action="" method="POST" class="w-full" id="deleteTypeForm">
                                @csrf
            ...
            <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                <button type="submit" @click.prevent="deleteType" id="deleteTypeAction"
                ...
                <button type="button" @click.prevent="closeModalDeleteType"
